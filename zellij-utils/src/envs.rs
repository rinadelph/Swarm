/// Uniformly operates SWARM* environment variables
use anyhow::Result;
...
pub const SWARM_ENV_KEY: &str = "SWARM";
pub fn get_swarm() -> Result<String> {
    Ok(var(SWARM_ENV_KEY)?)
}
pub fn set_swarm(v: String) {
    set_var(SWARM_ENV_KEY, v);
}

pub const SESSION_NAME_ENV_KEY: &str = "SWARM_SESSION_NAME";
...
pub const SOCKET_DIR_ENV_KEY: &str = "SWARM_SOCKET_DIR";
